...
# three inputs: 
# a cache, which is a Dictionary that maps inputs to proc to
# their previously computed values, 
# a procedure, proc, which can be called by
# just writing proc(proc_input), 
